...
public class PhotoPreview {
    ...
    public final static int BACK_RESULT_CODE = 888;
    public final static int DONE_RESULT_CODE = 999;
    ...
    public final static String EXTRA_ONLY_PREVIEW_SELECTED_PHOTOS = "only_preview_selected_photos";
    ...
    public static class PhotoPreviewBuilder {
        ...
        public Intent getIntent(@NonNull Context context) {
            mPreviewIntent.setClass(context, PhotoPageActivity.class);
        ...
        public PhotoPreviewBuilder setSelectedPhotos(ArrayList<String> selectedPhotos) {
            mPreviewOptionsBundle.putStringArrayList(EXTRA_SELECTED_PHOTOS, selectedPhotos);
            return this;
        }
        ...
        public PhotoPreviewBuilder setPhotoMaxCount(int maxCount) {
            mPreviewOptionsBundle.putInt(PhotoPickerConfig.EXTRA_MAX_COUNT, maxCount);
            return this;
        }

        public PhotoPreviewBuilder setOnlyPreviewSelectedPhotos(boolean previewSelectedPhotos) {
            mPreviewOptionsBundle.putBoolean(EXTRA_ONLY_PREVIEW_SELECTED_PHOTOS, previewSelectedPhotos);
            return this;
        }
    }
}
