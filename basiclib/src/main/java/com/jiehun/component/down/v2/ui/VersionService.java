...
import com.jiehun.component.down.callback.DownloadListener;
import com.jiehun.component.down.core.DownloadManager;
import com.jiehun.component.down.core.PermissionDialogActivity;
import com.jiehun.component.down.core.http.AllenHttp;
...
import com.jiehun.component.down.v2.builder.DownloadBuilder;
import com.jiehun.component.down.v2.builder.RequestVersionBuilder;
...
import com.jiehun.component.down.v2.net.DownloadMangerV2;
...
//        enqueueWork(context, VersionService.class, JOB_ID, new Intent());
    ...
    private void showVersionDialog() {
        Intent intent = new Intent(this, LSSUIActivity.class);
